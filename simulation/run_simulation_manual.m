...
%set_script_parameters([zeros(1, 21), 50, 300, 100, 1]);
set_script_parameters([zeros(1, 14), 180, 2000, 300, 10000, zeros(1, 7)]);
set_mcas_parameters([11, 2.5, 0.27, -999, -999, 0, 0.1, 0.105, 0.1]);
filename = append("../data-collection/simulation-export/manual_output.csv");
do_sim("takeoff", "sa_mcas", 300, evalin("base", "sortedParams"), 1, 0, 0, 0, filename);
