...
file_name = append("../data-collection/simulation-export/", ...
    "takeoff-stall", ...
    "_target-pitch-", string(evalin("base", "script_params(22)")), ...
    "_final-climb-airspeed-", string(evalin("base", "script_params(23)")), ...
    "_pitch-up-time-", string(evalin("base", "script_params(24)")), ...
    ".csv");
