...
file_name = append("../data-collection/simulation-export/", ...
    "landing", ...
    "_starting-alt-", string(evalin("base", "script_params(21)")), ...
    "_desc-rate-", string(evalin("base", "script_params(19)")), ...
    "_final-ref-airspeed-", string(evalin("base", "script_params(20)")), ...
    ".csv");
